...
<head>
    ...
    <!--vector maps -->
    <link rel="stylesheet" href="admin/js/vector-map/jquery-jvectormap-1.1.1.css">

    <!--right slidebar-->
    <link href="admin/css/slidebars.css" rel="stylesheet">

    <!--switchery-->
    <link href="admin/js/switchery/switchery.min.css" rel="stylesheet" type="text/css" media="screen" />

    <!--jquery-ui-->
    <link href="admin/js/jquery-ui/jquery-ui-1.10.1.custom.min.css" rel="stylesheet" />

    <!--iCheck-->
    <link href="admin/js/icheck/skins/all.css" rel="stylesheet">
                    ...
                    <ul class="nav navbar-nav">
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <ul class="col-sm-3 list-unstyled">
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="admin/img/mega-menu/mega_icon1.png" alt="" />
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="admin/img/mega-menu/mega_icon2.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Amaging Dashboard</span>
                                                                <span class="d-desk">Build with BS3</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="admin/img/mega-menu/mega_icon3.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">3500+ Satisfied Client</span>
                                                                <span class="d-desk">Max 5 star rating</span>
                                                                </span>
                                                ...
                                                <li>
                                                    <a href="javascript:;">
                                                        <img class="icon-img" src="admin/img/mega-menu/mega_icon4.png" alt="" />
                                                                <span class="icon-desk">
                                                                                        <span class="d-title">Easy to Cutomize</span>
                                                                <span class="d-desk">Very easy to use</span>
                                                                </span>
                        ...
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                            ...
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> German </span><img src="admin/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Italian </span> <img src="admin/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> French </span> <img src="admin/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Spanish </span> <img src="admin/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="javascript:;"><span> Russian </span> <img src="admin/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="online-chat-container">
                        ...
                        <ul class="team-list chat-list-side">
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="admin/img/img2.jpg" alt="">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="admin/img/img3.jpg" alt="">
                                <i class="offline dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
                            ...
                            <li>
                                <a href="#">
                                        <span class="thumb-small">
                                <img class="circle" src="admin/img/img1.jpg" alt="">
                                <i class="offline dot"></i>
                            </span>
                                    <div class="inline">
                                            <span class="name">
...
<!--jquery-ui-->
<script src="admin/js/jquery-ui/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
...
<script src="admin/js/switchery/switchery-init.js"></script>

<!--flot chart -->
<script src="admin/admin/js/flot-chart/jquery.flot.js"></script>
<script src="admin/js/flot-chart/flot-spline.js"></script>
...
<script src="admin/js/flot-chart/jquery.flot.pie.js"></script>
<script src="admin/js/flot-chart/jquery.flot.selection.js"></script>
<script src="admin/js/flot-chart/jquery.flot.stack.js"></script>
<script src="admin/js/flot-chart/jquery.flot.crosshair.js"></script>


<!--earning chart init-->
<script src="admin/js/earning-chart-init.js"></script>
...
<!--easy pie chart-->
<script src="admin/js/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
<script src="admin/js/easy-pie-chart.js"></script>


<!--vectormap-->
<script src="admin/js/vector-map/jquery-jvectormap-1.2.2.min.js"></script>
<script src="admin/js/vector-map/jquery-jvectormap-world-mill-en.js"></script>
<script src="admin/js/dashboard-vmap-init.js"></script>

<!--Icheck-->
<script src="admin/js/icheck/skins/icheck.min.js"></script>
<script src="admin/js/todo-init.js"></script>

<!--jquery countTo-->
<script src="admin/js/jquery-countTo/jquery.countTo.js"  type="text/javascript"></script>
