...
<head>
    ...
    <title>{{ isset($title) ? $title . ' - Rolim Net | Central do Cliente' : null }}</title>
    ...
    <section>
        ...
        <div class="sidebar-left">
            ...
            <div class="logo dark-logo-bg visible-xs-* visible-sm-*">
                <a href="{{ route('centralcliente.index') }}">
                    <!--<img src="admin/img/logo-icon.png" alt="">-->
                    <!--<i class="fa fa-maxcdn"></i>-->
                    <span class="brand-name">Central do Cliente</span>
                </a>
            </div>
            ...
            <div class="sidebar-left-info">
                ...
                <ul class="nav nav-pills nav-stacked side-navigation">
                    ...
                    <li class="{{ active('centralcliente.index') }}"><a href="{{ route('centralcliente.index') }}"><i class="fa fa-home"></i> <span>Página Inicial</span></a></li>
                    <li class="menu-list {{ active('centralcliente.tickets.*') }}">
                        <a href=""><i class="fa fa-laptop"></i>  <span>Meus tickets</span></a>
                        <ul class="child-list">
                            <li class="{{ active('centralcliente.tickets.create') }}"><a href="{{route('centralcliente.tickets.create')}}"> Novo</a></li>
                        ...
                        <li>
                            ...
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                ...
                                <li>
                                    ...
                                    <li>
                                        <a href="{{ url('central-cliente/logout') }}"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                            Sair
                                        </a>

                                        <form id="logout-form" action="{{ url('central-cliente/logout') }}" method="POST" style="display: none;">
                                            {{ csrf_field() }}
                                        </form>
                                    </li>
                            </ul>
